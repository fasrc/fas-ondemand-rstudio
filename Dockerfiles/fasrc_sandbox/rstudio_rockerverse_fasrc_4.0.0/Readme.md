...
```sh
$> sudo docker build -t rstudio_rockerverse_fasrc:4.0.0 .
$> mkdir -p /data/sing-images/Fall_2020/fasrc_sandbox
$> mkdir -p /data/tmp
$> sudo docker run -v /var/run/docker.sock:/var/run/docker.sock -v /data/sing-images/Fall_2020/fasrc_sandbox:/output -v /data/tmp:/tmp --privileged -t --rm quay.io/singularity/docker2singularity rstudio_rockerverse_fasrc:4.0.0 
### copy the resulting image to 
cp  /data/tmp/rstudio_rockerverse_fasrc_4.0.0*sif ${CONTAINERS_FOLDER}/fasrc_sandbox_rstudio/rstudio_rockerverse_fasrc_4.0.0/rstudio_rockerverse_fasrc_4.0.0.sif
```

The curent reference container includes the following R packages :
```sh
             Package        LibPath                         Version
arrow        "arrow"        "/usr/local/lib/R/site-library" "0.17.1"
askpass      "askpass"      "/usr/local/lib/R/site-library" "1.1"
assertthat   "assertthat"   "/usr/local/lib/R/site-library" "0.2.1"
backports    "backports"    "/usr/local/lib/R/site-library" "1.1.7"
...
blogdown     "blogdown"     "/usr/local/lib/R/site-library" "0.19"
bookdown     "bookdown"     "/usr/local/lib/R/site-library" "0.19"
brew         "brew"         "/usr/local/lib/R/site-library" "1.0-6"
broom        "broom"        "/usr/local/lib/R/site-library" "0.5.6"
...
dplyr        "dplyr"        "/usr/local/lib/R/site-library" "1.0.0"
...
ggplot2      "ggplot2"      "/usr/local/lib/R/site-library" "3.3.1"
...
littler      "littler"      "/usr/local/lib/R/site-library" "0.3.10"
...
pillar       "pillar"       "/usr/local/lib/R/site-library" "1.4.4"
pkgbuild     "pkgbuild"     "/usr/local/lib/R/site-library" "1.0.8"
...
ps           "ps"           "/usr/local/lib/R/site-library" "1.3.3"
...
rlang        "rlang"        "/usr/local/lib/R/site-library" "0.4.6"
RMariaDB     "RMariaDB"     "/usr/local/lib/R/site-library" "1.0.8"
rmarkdown    "rmarkdown"    "/usr/local/lib/R/site-library" "2.2"
...
tibble       "tibble"       "/usr/local/lib/R/site-library" "3.0.1"
tidyr        "tidyr"        "/usr/local/lib/R/site-library" "1.1.0"
tidyselect   "tidyselect"   "/usr/local/lib/R/site-library" "1.1.0"
tidyverse    "tidyverse"    "/usr/local/lib/R/site-library" "1.3.0"
tinytex      "tinytex"      "/usr/local/lib/R/site-library" "0.23"
...
vctrs        "vctrs"        "/usr/local/lib/R/site-library" "0.3.1"
...
xfun         "xfun"         "/usr/local/lib/R/site-library" "0.14"
...
base         "base"         "/usr/local/lib/R/library"      "4.0.0"
boot         "boot"         "/usr/local/lib/R/library"      "1.3-24"
class        "class"        "/usr/local/lib/R/library"      "7.3-16"
cluster      "cluster"      "/usr/local/lib/R/library"      "2.1.0"
codetools    "codetools"    "/usr/local/lib/R/library"      "0.2-16"
compiler     "compiler"     "/usr/local/lib/R/library"      "4.0.0"
datasets     "datasets"     "/usr/local/lib/R/library"      "4.0.0"
foreign      "foreign"      "/usr/local/lib/R/library"      "0.8-78"
graphics     "graphics"     "/usr/local/lib/R/library"      "4.0.0"
grDevices    "grDevices"    "/usr/local/lib/R/library"      "4.0.0"
grid         "grid"         "/usr/local/lib/R/library"      "4.0.0"
...
methods      "methods"      "/usr/local/lib/R/library"      "4.0.0"
mgcv         "mgcv"         "/usr/local/lib/R/library"      "1.8-31"
nlme         "nlme"         "/usr/local/lib/R/library"      "3.1-147"
nnet         "nnet"         "/usr/local/lib/R/library"      "7.3-13"
parallel     "parallel"     "/usr/local/lib/R/library"      "4.0.0"
rpart        "rpart"        "/usr/local/lib/R/library"      "4.1-15"
spatial      "spatial"      "/usr/local/lib/R/library"      "7.3-11"
splines      "splines"      "/usr/local/lib/R/library"      "4.0.0"
stats        "stats"        "/usr/local/lib/R/library"      "4.0.0"
stats4       "stats4"       "/usr/local/lib/R/library"      "4.0.0"
survival     "survival"     "/usr/local/lib/R/library"      "3.1-12"
tcltk        "tcltk"        "/usr/local/lib/R/library"      "4.0.0"
tools        "tools"        "/usr/local/lib/R/library"      "4.0.0"
utils        "utils"        "/usr/local/lib/R/library"      "4.0.0"
```
